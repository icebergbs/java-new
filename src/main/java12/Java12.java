...
public class Java12 {
    ...
    public static void main(String[] args) {
        ...
        /** 1、JDK12 之 Shenandoah 低暂停时间垃圾收集器（实验性） */
        // 定义：
        //
        ...
        /** 2、JDK12 之 Microbenchmark Suite */
        //定义：
        //
        ...
        /** 3. JDK12 之 Switch 表达式（预览版） */


        /** 4、JDK12 之 JVM 常量 API */
        // 摘要：
        //
        ...
        /**  9、核心库 java.lang 中支持 Unicode11  */
        //    JDK 12 版本包括对 Unicode 11.0.0 的支持。在发布支持 Unicode 10.0.0 的 JDK 11 之后，
        //   Unicode 11.0.0 引入了以下 JDK 12 中包含的新功能：
        //
        //1、684个新角色
        //    1.1、66个表情符号字符
        //    1.2、Copyleft符号
